...
;ณ
;ณ SET_EQUIPMENT_WORD
;ณ ------------------
;ณ
;ณ  Change the equipment word to reflect the new number of columns.  If the
;ณ  current mode is MONO then no change will be done because the number of
;ณ  columns cannot be changed on a monochrome display.
;ณ
;ณ  INPUT: DX=setting for the video bits
;ณ
;ณ
;ณ  RETURN: equipment word changed if not in MONO mode
;ณ
;ณ
;ณ  MESSAGES: none
;ณ
;ณ  REGISTER  AX - used for masking and testing bits
;ณ  USAGE:    ES - holds segment of ROM data area
;ณ
;ณ
;ณ  ASSUMPTIONS: The user requested only a cloumns change, i.e. did not want to
;ณ               change the active display.
;ณ
;ณ               DX will be either 0010 or 0020.
;ณ
;ณ               ES was assumed to nothing.
;ณ
;ณ
;ณ  SIDE EFFECT: AX destroyed
;ณ
;ณ                                                                                                                         ;AN000;
