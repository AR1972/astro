...
del %OAKROOT%\DEV\RAMDRIVE\*.OBJ
del %OAKROOT%\DEV\RAMDRIVE\*.SYS
del %OAKROOT%\DEV\RAMDRIVE\*.SY_
del %OAKROOT%\DEV\RAMDRIVE\*.EXS
del %OAKROOT%\DEV\RAMDRIVE\MESSAGES.ASM
...
del %OAKROOT%\DOSSHELL\INC\*.HS
del %OAKROOT%\DOSSHELL\INC\*.SDM

del %OAKROOT%\LIB\LDECOMPR.LIB
del %OAKROOT%\LIB\MDECOMPR.LIB
del %OAKROOT%\LIB\SDECOMPR.LIB
