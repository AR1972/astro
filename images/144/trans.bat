...
echo *************************************************************************
echo *                                                                       *
echo *  This version requires three 1.44Mb and one 720K floppy disks         *
...
:DISK3
echo 
echo Disk #3: Enter a 1.44M disk in %1
..\tools\ync /c msx "Make, Skip, eXit"
if ERRORLEVEL 2 goto EGRESS
...
:DISK4
echo 
echo Supplemental Disk 1: Enter a 720K disk in %1
..\tools\ync /c msx "Make, Skip, eXit"
if ERRORLEVEL 2 goto EGRESS
...
GOTO DONE
echo 
echo Supplemental Disk 2: Enter a 720K disk in %1
..\tools\ync /c msx "Make, Skip, eXit"
if ERRORLEVEL 2 goto EGRESS
