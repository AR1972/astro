...
echo *************************************************************************
echo *                                                                       *
echo *  This version requires three 1.2Mb floppy disks                       *                                                                 *
...
:DISK3
echo 
echo Supplemental Disk #1: Insert a 1.2M disk in %1
..\tools\ync /c msx "Make, Skip, eXit"
if ERRORLEVEL 2 goto EGRESS
...
:DISK5
echo 
echo Disk #5: Insert a 1.2M disk in %1
...
:DISK6
echo 
echo Disk #6: Insert a 360K disk in %1
..\tools\ync /c msx "Make, Skip, eXit"
if ERRORLEVEL 2 goto EGRESS
