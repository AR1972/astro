...
; *                      All Rights Reserved.
; */
;; Change for MS-DOS 6 RAID #6426 - top row shift and CAPSLOCK
;;   Keyboard TOP ROW is now UNSHIFTED when CAPS LOCK is ON
;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ANDF EITHER_CTL,NOT		       ;;
    IFKBD G_KB+P12_KB		       ;; FUNCTIONS AS A SHIFT LOCK
     IFF CAPS_STATE		       ;;
     ANDF EITHER_SHIFT		       ;;
         SET_FLAG DEAD_UPPER           ;; #6426 - top row shift and CAPSLOCK
     ELSEF
	IFF CAPS_STATE			 ;;
          SET_FLAG DEAD_LOWER          ;; #6426 - top row shift and CAPSLOCK
	ELSEF
	 IFF EITHER_SHIFT		;;
	  SET_FLAG DEAD_UPPER	       ;;
	 ELSEF
...
;;	  XLATT NON_ALPHA_LOWER        ;;
	 IFKBD G_KB+P12_KB	       ;; G & p12 NO shift state
	  IFF CAPS_STATE	       ;;
	     XLATT ALPHA_UPPER	       ;;
             XLATT NON_ALPHA_LOWER     ;; #6426 - top row shift
	  ELSEF 		       ;;
	     XLATT ALPHA_LOWER	       ;;
	     XLATT NON_ALPHA_LOWER	  ;;
	  ENDIFF		       ;;
