...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   DB    STANDARD_TABLE+ZERO_SCAN      ;; xlat options:
   DB    1                             ;; number of scans
   DB    1ah,39                        ;; scan code,ASCII - ACUTE   <verav>
				       ;;
COM_AC_AC_T1_END:                      ;;
				       ;;
   DW    0                             ;; Size of xlat table - null table
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
				       ;;
   DW    COM_ctrl_case_END-$            ;; length of state section
   DB    ctrl_case                      ;; State ID
   DW    ANY_KB                        ;; Keyboard Type
   DB    -1,-1                         ;; error character = standalone accent
				       ;;
   DW    COM_ctrl_case_T1_END-$            ;; Size of xlat table
   DB    STANDARD_TABLE+ZERO_SCAN      ;; xlat options:
   DB    3                             ;; number of scans
   DB    1bh,1bh                       ;; 
   db    56h,1ch                       ;;
   db    2bh,1dh                       ;;
COM_ctrl_case_T1_END:                   ;;
				       ;;
   DW    0                             ;; Size of xlat table - null table
				       ;;
COM_ctrl_case_END:                         ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   db    7eh,'.'                       ;; ponto no teclado numerico
COM_NALC_T1_END:                       ;;
				       ;;
   DW    0                             ;; Size of xlat table - null table
				       ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
				       ;;
   DW    COM_Num_state2_END-$           ;; length of state section
   DB    NUMERIC_PAD                   ;; State ID
   DW    ANY_KB                        ;; Keyboard Type
   DB    -1,-1                         ;; error character - buffer entry
				       ;;
   DW    COM_Num_State2_T1_END-$       ;; Size of xlat table
   DB    STANDARD_TABLE+ZERO_SCAN      ;; xlat options:
   DB    1                             ;; number of scans
   DB    53h,','                       ;; virgula
COM_Num_State2_T1_END:                 ;;      
				       ;;
   DW    0                             ;; Size of xlat table - null table
				       ;;
COM_Num_State2_END:                    ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   db    2bh,0a7h                      ; primeiro    ß
   db    73h,0f8h                      ; grau
   db    0dh,015h                      ; paragrafo
